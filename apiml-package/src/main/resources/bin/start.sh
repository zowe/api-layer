...
_BPX_JOBNAME=${ZWE_zowe_job_prefix}${APIML_CODE} ${JAVA_BIN_DIR}java \
    ...
    -Dapiml.security.personalAccessToken.cutoverEpoch=${ZWE_components_gateway_apiml_security_personalAccessToken_cutoverEpoch:-${ZWE_configs_apiml_security_personalAccessToken_cutoverEpoch:-0}} \
    ...
    -Dapiml.security.personalAccessToken.revocationLookupTimeoutMillis=${ZWE_components_gateway_apiml_security_personalAccessToken_revocationLookupTimeoutMillis:-${ZWE_configs_apiml_security_personalAccessToken_revocationLookupTimeoutMillis:-2000}} \
    -Dapiml.security.personalAccessToken.revocationLookupFailureThreshold=${ZWE_components_gateway_apiml_security_personalAccessToken_revocationLookupFailureThreshold:-${ZWE_configs_apiml_security_personalAccessToken_revocationLookupFailureThreshold:-5}} \
    -Dapiml.security.personalAccessToken.revocationLookupCircuitOpenMillis=${ZWE_components_gateway_apiml_security_personalAccessToken_revocationLookupCircuitOpenMillis:-${ZWE_configs_apiml_security_personalAccessToken_revocationLookupCircuitOpenMillis:-10000}} \

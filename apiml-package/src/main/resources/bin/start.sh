...
_BPX_JOBNAME=${ZWE_zowe_job_prefix}${APIML_CODE} ${JAVA_BIN_DIR}java \
    ...
    -Dapiml.discovery.password=${ZWE_components_discovery_apiml_discovery_password:-${ZWE_configs_apiml_discovery_password:-}} \
    ...
    -Dapiml.discovery.userid=${ZWE_components_discovery_apiml_discovery_userid:-${ZWE_configs_apiml_discovery_userid:-}} \

...
# - ZWE_components_discovery_server_prefix_replacer - The service ID prefix replacer to be V2 conformant
if [ ${LAUNCH_COMPONENT} ]
then
...
_BPX_JOBNAME=${ZWE_zowe_job_prefix}${DISCOVERY_CODE} java -Xms32m -Xmx256m ${QUICK_START} \
    ...
    -Dapiml.discovery.serviceIdPrefixReplacer=${ZWE_components_discovery_server_prefix_replacer} \

...
class MetadataValidatorTest {
    ...
    void setUp() {
        ...
        metadataValidator = new MetadataValidator(instanceInfo, null, null, false);
    }
    ...
    @CsvSource(delimiterString = "|", value = {
        ...
        "localhost|127.0.0.1:8080|true|true",
        "localhost|invalid#1|false|true",
        "[::1]|[::1]:8080|true|true",
        "[::1]:*|[::2]|false|true",
        "[2001:db8::1]|[2001:db8::1]:8080|true|true",
        "[2001:db8::1]|[2001:db8::2]|false|true",
        "2001:db8::/32|[2001:db8:abcd:1234::1]:8080|true|true",
        "2001:db8::/32|[2001:db9::1]|false|true",
        "[fe80::]/10|[fe80::1234:5678:9abc]:8080|true|true",
        "[fe80::]/10|[fc00::1]|false|true",
        "2001:db8::/64|[2001:db8:0:0:ffff:ffff:ffff:ffff]:8080|true|true",
        "2001:db8::/64|[2001:db8:0:1::1]|false|true",
        "localhost,192.168.0.0/24,2001:db8::/32|192.168.0.10:8080|true|true",
        ...
        "192.168.0.0/24|192.168.0.55:8080|true|true",
        "192.168.0.0/24|192.168.1.1|false|true",
        "10.0.0.0/8|10.255.255.255:8080|true|true",
        "10.0.0.0/8|11.0.0.1|false|true",
        "172.16.0.0/12|172.31.255.254:8080|true|true",
        "172.16.0.0/12|172.32.0.1|false|true",
        "192.168.0.0/32|192.168.0.0:8080|true|true",
        ...
        "localhost|https://localhost:8080/v3/api-doc|true|true",

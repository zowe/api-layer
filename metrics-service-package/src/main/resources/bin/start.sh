...
_BPX_JOBNAME=${ZWE_zowe_job_prefix}${METRICS_CODE} java \
  ...
  -Dapiml.httpclient.ssl.enabled-protocols=${ZWE_components_gateway_apiml_httpclient_ssl_enabled_protocols:-ZWE_configs_zowe_network_client_tls_maxTls:-ZWE_network_client_tls_maxTls:-"TLSv1.2"} \
  -Dserver.address=${ZWE_configs_zowe_network_server_listenAddresses_0:-ZWE_network_server_listenAddresses_0:-"0.0.0.0"} \
  -Dserver.ssl.enabled=${ZWE_components_gateway_server_ssl_enabled:-true} \
  -Dserver.ssl.protocol=${ZWE_components_gateway_server_ssl_protocol:-ZWE_configs_zowe_network_server_tls_maxTls:-ZWE_network_server_tls_maxTls:-"TLSv1.2"}  \

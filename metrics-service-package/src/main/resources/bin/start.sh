...
_BPX_JOBNAME=${ZWE_zowe_job_prefix}${METRICS_CODE} java \
  ...
  -Dapiml.httpclient.ssl.enabled-protocols=${ZWE_components_gateway_apiml_httpclient_ssl_enabled_protocols:-ZWE_configs_zowe_network_client_maxTls:-ZWE_network_client_maxTls:-"TLSv1.2"} \
  ...
  -Dserver.ssl.protocol=${ZWE_components_gateway_server_ssl_protocol:-ZWE_configs_zowe_network_server_maxTls:-ZWE_network_server_maxTls:-"TLSv1.2"}  \

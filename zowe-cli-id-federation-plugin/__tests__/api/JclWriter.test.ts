    ...
    describe("format", () => {
        ...
        it("the second long word is split on the second line", () => {
            ...
            expect(formated).toBe(
                ...
                '  word2_123456789012345678901234567890123456789012345678901234567890123X\n' +
                // second part of word2
                '45678901234567890123456789012345678901234567890123456789012345678901234X\n' +
                // third part of word2 and word3
                '567890123456789012345678901234567890123456789012345678901234 word3'
            );
        });
        ...
        it("too long word followed with other one with enough room for enter character", () => {
            ...
            const formater = jclWriter.format([
                'word1_'.padEnd(2 * 71 - 4 - 2, '1234567890'),
                'word2'
            ]);
            expect(formater).toBe(
                '    word1_1234567890123456789012345678901234567890123456789012345678901X\n' +
        ...
        it("too long word followed with the last short word", () => {
            ...
            expect(formater).toBe(
                '    word1_1234567890123456789012345678901234567890123456789012345678901X\n' +
                '234567890123456789012345678901234567890123456789012345678901234567890 2'
            );
        });

...
_BPX_JOBNAME=${ZOWE_PREFIX}${GATEWAY_CODE} java \
    ...
    -Dserver.internal.ssl.keyAlias=${APIML_GATEWAY_INTERNAL_SSL_KEY_ALIAS:-localhost} \
    -Dserver.internal.ssl.keyStore=${APIML_GATEWAY_INTERNAL_SSL_KEYSTORE:-keystore/service/service.keystore.p12} \

...
describe('>>> Wizard reducer tests', () => {
    ...
    it('should handle SELECT_ENABLER with navs', () => {
        ...
        const dummyData = [{ text: 'CAT #0' }, { text: 'CAT #1' }];
    ...
    it('should handle REMOVE_INDEX', () => {
        const expectedState = {
            inputData: [
                {
                    text: 'Category 1',
                    content: [{ test: { value: '', question: 'Why?' } }, { test: { value: '', question: 'Why?' } }],
                },
            ],
        };
        expect(
    ...
    it('should handle VALIDATE_INPUT when content is an array', () => {
        const expectedState = {
            inputData: [
                { text: 'Category 1', content: [{ test: { value: '', question: 'Why?' } }], nav: 'Nav' },
                {
                    text: 'Category 2',
                    content: [{ test2: { value: 'val', question: 'Why?', empty: true, problem: true } }],
                    nav: 'Nav',
                },
            ],
            navsObj: {
    ...
    it('should override static definition', () => {
        ...
        expect(
            wizardReducer(
                { confirmDialog: false, wizardIsOpen: true },
                {
                    type: OVERRIDE_DEF,
                }
            )

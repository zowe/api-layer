...
describe('>>> Detail page test', () => {
    ...
    it('Should display the API Catalog service title, URL and description in Swagger', () => {
        ...
        cy.get(
            '#root > div > div.content > div.detail-page > div.content-description-container > div > div.tabs-swagger > div.serviceTab > div.header > a'
        )
    ...
    it('Should display the Gateway information in the detail page', () => {
        ...
        cy.get(
            '#root > div > div.content > div.detail-page > div.content-description-container > div > div.tabs-swagger > div.serviceTab > div.header > h6:nth-child(7)'
        )
            .should('exist')
            .should(
                'contain',

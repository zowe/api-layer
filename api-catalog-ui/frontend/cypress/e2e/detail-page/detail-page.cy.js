...
describe('>>> Detail page test', () => {
    ...
    it('Should display the API Catalog service title, URL and description in Swagger', () => {
        ...
        cy.get(
            ...
            .should('contain', `${baseUrl.match(/^https?:\/\/([^/?#]+)(?:[/?#]|$)/i)[1]}/apicatalog/ui`); // TODO This originally /ui/v1 but now /ui is selected for service homepage URL, see https://github.com/zowe/api-layer/issues/3652 to verify if it needs to be restored

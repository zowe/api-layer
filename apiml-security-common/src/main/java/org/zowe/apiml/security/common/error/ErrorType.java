...
public enum ErrorType {
    ...
    AUTH_METHOD_NOT_SUPPORTED("org.zowe.apiml.common.methodNotAllowed", "The request method has been disabled and cannot be used for the requested resource.", "Use the correct HTTP request method that is supported for the URL."),

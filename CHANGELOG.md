...
- Feature: API Catalog versioning enhancement by adding API differences tab to the API Catalog so the user can compare versions of two APIs. [#923](https://github.com/zowe/api-layer/issues/923)

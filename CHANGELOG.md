...
* Bugfix:  Don't log the failure messages irrelevant for all the problems. (#3542) ([714fa6a](https://github.com/zowe/api-layer/commit/714fa6a)), closes [#3542](https://github.com/zowe/api-layer/issues/3542)
* Bugfix:  Proper reading OIDC configuration from system environment (#3537) ([c1a1c9f](https://github.com/zowe/api-layer/commit/c1a1c9f)), closes [#3537](https://github.com/zowe/api-layer/issues/3537)

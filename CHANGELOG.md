...
* Feature: Caching Service mutual authentication. An API ML client certificate is now required to call the Caching Service. (#1231) ([1cfee86](https://github.com/zowe/api-layer/commit/1cfee86)), closes [#1231](https://github.com/zowe/api-layer/issues/1231)
* Feature (Caching service): Replace the JWT with a client certificate in the Caching Service. This feature supports High Availability. (#1217) ([e496ac8](https://github.com/zowe/api-layer/commit/e496ac8)), closes [#1217](https://github.com/zowe/api-layer/issues/1217)

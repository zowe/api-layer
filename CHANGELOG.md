...
* Feature:  eureka client connection timeout (#4046) ([6a1f73e](https://github.com/zowe/api-layer/commit/6a1f73e)), closes [#4046](https://github.com/zowe/api-layer/issues/4046)
* Feature:  v2 with java 21 (#4027) ([6a554ba](https://github.com/zowe/api-layer/commit/6a554ba)), closes [#4027](https://github.com/zowe/api-layer/issues/4027)
...
* Bugfix:  gateway returns empty auth keys from zosmf when jwtAutoconfiguration is jwt (#4221) ([ae708f3](https://github.com/zowe/api-layer/commit/ae708f3)), closes [#4221](https://github.com/zowe/api-layer/issues/4221)
* Bugfix:  disable infinispan diagnostics by default (#4170) ([a80a2f9](https://github.com/zowe/api-layer/commit/a80a2f9)), closes [#4170](https://github.com/zowe/api-layer/issues/4170)
* Bugfix:  logout in API Catalog call to Gateway (#4185) ([cbce1ea](https://github.com/zowe/api-layer/commit/cbce1ea)), closes [#4185](https://github.com/zowe/api-layer/issues/4185)
* Bugfix:  NPE in ApimlPeerEurekaNode stops heartbeats (#4195) ([6fba33d](https://github.com/zowe/api-layer/commit/6fba33d)), closes [#4195](https://github.com/zowe/api-layer/issues/4195)
* Bugfix:  Secure x-forwarded-* headers from untrusted proxies but trust all apiml proxies (v2) (#4188) ([d9dfd17](https://github.com/zowe/api-layer/commit/d9dfd17)), closes [#4188](https://github.com/zowe/api-layer/issues/4188)
* Bugfix:  Fix handling of closeable resources (#4153) ([1acce27](https://github.com/zowe/api-layer/commit/1acce27))
* Bugfix:  Fix trusted proxies in Forwarded headers v2 (#4148) ([55c9db6](https://github.com/zowe/api-layer/commit/55c9db6)), closes [#4148](https://github.com/zowe/api-layer/issues/4148)
...
* Bugfix:  change error code SERVICE_UNAVAILABLE to INTERNAL_SERVER_ERROR when ticket generation fails (#4 ([f7f78dd](https://github.com/zowe/api-layer/commit/f7f78dd)), closes [#4043](https://github.com/zowe/api-layer/issues/4043)
...
* Bugfix:  ciphers list v2 (#4026) ([38a3e54](https://github.com/zowe/api-layer/commit/38a3e54)), closes [#4026](https://github.com/zowe/api-layer/issues/4026)
* Bugfix:  default ciphers list (#4023) ([d6563e4](https://github.com/zowe/api-layer/commit/d6563e4)), closes [#4023](https://github.com/zowe/api-layer/issues/4023)
...
* Bugfix:  fix issue with login filter (#4014) ([84cac88](https://github.com/zowe/api-layer/commit/84cac88)), closes [#4014](https://github.com/zowe/api-layer/issues/4014)
...
* Bugfix:  improve PassTicket logging (V2) (#3996) ([8223a14](https://github.com/zowe/api-layer/commit/8223a14)), closes [#3996](https://github.com/zowe/api-layer/issues/3996)
* Bugfix:  LoginFilter failing in AccessToken generate filter chain (#3984) ([7acb2ee](https://github.com/zowe/api-layer/commit/7acb2ee)), closes [#3984](https://github.com/zowe/api-layer/issues/3984)
* Bugfix:  ssl.protocol default value (#3994) ([8abb6e6](https://github.com/zowe/api-layer/commit/8abb6e6)), closes [#3994](https://github.com/zowe/api-layer/issues/3994)
* Bugfix:  do not leak 'exampleSetFlag' in api doc (v2.x.x) (#3934) ([0211ba5](https://github.com/zowe/api-layer/commit/0211ba5)), closes [#3934](https://github.com/zowe/api-layer/issues/3934)
...
* Bugfix:  tls version and cipher suit configuration (#3943) ([012da72](https://github.com/zowe/api-layer/commit/012da72)), closes [#3943](https://github.com/zowe/api-layer/issues/3943)
* Bugfix:  Use writeble headers on first. Solve the conflict with RequestAttributesProvider (#3965) ([9f9b5da](https://github.com/zowe/api-layer/commit/9f9b5da)), closes [#3965](https://github.com/zowe/api-layer/issues/3965)
* Bugfix:  z/OSMF static definition file processing (v2) (#3975) ([85aa6a7](https://github.com/zowe/api-layer/commit/85aa6a7)), closes [#3975](https://github.com/zowe/api-layer/issues/3975)
...
* Bugfix:  sonar analysis for v2 (#3800) ([d4f6145](https://github.com/zowe/api-layer/commit/d4f6145)), closes [#3800](https://github.com/zowe/api-layer/issues/3800)
* Bugfix:  throw insecureHttpWarning message only when attls is not enabled (#3810) ([b846083](https://github.com/zowe/api-layer/commit/b846083)), closes [#3810](https://github.com/zowe/api-layer/issues/3810)
* Bugfix:  WebSocket non-blocking session opening (#3695) ([b6f2461](https://github.com/zowe/api-layer/commit/b6f2461)), closes [#3695](https://github.com/zowe/api-layer/issues/3695)
* Bugfix:  zowe cli plugin (#3804) ([6ba9242](https://github.com/zowe/api-layer/commit/6ba9242)), closes [#3804](https://github.com/zowe/api-layer/issues/3804)

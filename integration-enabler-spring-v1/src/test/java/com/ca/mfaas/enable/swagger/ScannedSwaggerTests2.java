...
import com.ca.mfaas.SpringBootTestClassForIntegrationEnablement;
...
public class ScannedSwaggerTests2 {
    ...
    @Test
    public void givenNoSwaggerLocationThenAutoscanForSwagger() throws IOException {
        ...
        Assert.assertEquals("Sample micro-service showing how to enable a Spring Boot v1.5.9 application"
            , description.asText());
        Assert.assertEquals("1.0.0", version.asText());
    }
}

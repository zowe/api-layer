...
public abstract class AbstractIRRPassTicketException extends Exception {
    ...
    public enum ErrorCode {
        ...
        ERR_0_0_0(0, 0, 0, HttpStatus.SC_INTERNAL_SERVER_ERROR, "The service was successful."),
        ERR_4_0_0(4, 0, 0, HttpStatus.SC_INTERNAL_SERVER_ERROR, "RACF is not installed."),
        ERR_8_8_0(8, 8, 0, HttpStatus.SC_INTERNAL_SERVER_ERROR, "Invalid function code."),

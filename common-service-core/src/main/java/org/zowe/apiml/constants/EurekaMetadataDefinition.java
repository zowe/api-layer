...
public final class EurekaMetadataDefinition {
    ...
    public static final String CATALOG_ID_V1 = "apiml.service.catalog.tile.id";
    public static final String CATALOG_VERSION_V1 = "apiml.service.catalog.tile.version";
    public static final String CATALOG_TITLE_V1 = "apiml.service.catalog.tile.title";
    public static final String CATALOG_DESCRIPTION_V1 = "apiml.service.catalog.tile.description";

    public static final String SERVICE_TITLE_V1 = "apiml.service.title";

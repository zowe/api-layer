...
# - ZWE_configs_storage_maxQueryKeys
# - ZWE_configs_storage_infinispan_distributedSyncTimeoutSecs
# - ZWE_configs_storage_infinispan_numSegments
# - ZWE_configs_storage_infinispan_revocationStore_maxCount
# - ZWE_configs_storage_infinispan_revocationStore_sizeWarningThreshold
...
_BPX_JOBNAME=${ZWE_zowe_job_prefix}${CACHING_CODE} ${JAVA_BIN_DIR}java \
  ...
  -Dcaching.storage.infinispan.distributedSyncTimeoutSecs=${ZWE_configs_storage_infinispan_distributedSyncTimeoutSecs:-360} \
  -Dcaching.storage.infinispan.numSegments=${ZWE_configs_storage_infinispan_numSegments:-256} \
  -Dcaching.storage.infinispan.revocationStore.maxCount=${ZWE_configs_storage_infinispan_revocationStore_maxCount:-100000} \
  -Dcaching.storage.infinispan.revocationStore.sizeWarningThreshold=${ZWE_configs_storage_infinispan_revocationStore_sizeWarningThreshold:-50000} \
  -Dcaching.storage.maxQueryKeys=${ZWE_configs_storage_maxQueryKeys:-66} \

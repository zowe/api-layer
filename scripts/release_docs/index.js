...
(async function () {
    ...
    try {
        ...
        let convChangeCheckout = `git fetch --unshallow --tags origin apiml/GH2405/fix_gh_workflow > /dev/null 2>&1 && git checkout origin/apiml/GH2405/fix_gh_workflow > /dev/null 2>&1 && git --no-pager log`;

...
public enum ZaasClientErrorCodes {
    ...
    INTERNAL_SERVER_ERROR("ZWEAS418E", "The generation of the PassTicket failed. Verify that the user and the application name are valid, and check that corresponding permissions have been set up.", 500),

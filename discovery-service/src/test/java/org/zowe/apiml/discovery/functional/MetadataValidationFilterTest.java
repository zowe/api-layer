...
class MetadataValidationFilterTest extends DiscoveryFunctionalTest {
    ...
    class GivenOnboarding {
        ...
        void whenInvalidMetadata_thenBlockWithMessage() {
            String serviceId = "MOCKSERVICE";
            Map<String, String> metadata = new HashMap<>();
            metadata.put("apiml.apiInfo.0.swaggerUrl", "https://not-allowed.example.org/api-doc");

            InstanceInfo mockInstance = InstanceInfo.Builder.newBuilder()
            ...
            String registrationRequest = EurekaJacksonCodec.getInstance().writeToString(mockInstance);
            ...
            assertEquals("{\"messages\":[{\"messageType\":\"WARNING\",\"messageNumber\":\"ZWEAM604W\",\"messageContent\":\"Invalid metadata found in registration\",\"messageAction\":\"Validate URL / IP Address against the allowed domains configuration.\",\"messageReason\":\"The URL / IP Address is not allowed\",\"messageKey\":\"org.zowe.apiml.common.metadataNotAllowedInRegistration\"}]}", responseBody);

...
/**
 * Starts the full Discovery Service context and registers a real service through the registry.
...
class MissingApplidRegistrationTest extends DiscoveryFunctionalTest {
    ...
    private final Logger registryLogger = (Logger) LoggerFactory.getLogger(ConformanceWarningInterceptor.class);
    ...
    private ServiceInstance passTicketInstance(String serviceId, String applid) {
        ...
        return ServiceInstance.builder()
            .instanceId("localhost:" + serviceId + ":10010")
            .appName(serviceId)
            .ipAddr("127.0.0.1")
            .securePort(10010, true)
            .hostName("localhost")
    ...
    void givenServiceWithPassTicketAndNoApplid_whenRegistered_thenWarningIsLogged() {
        registry.register(passTicketInstance("SERVICEUSINGPASSTICKET", null), RegistrationKind.DYNAMIC);
    ...
    void givenServiceWithPassTicketAndApplid_whenRegistered_thenNoWarning() {
        registry.register(passTicketInstance("SERVICEWITHAPPLID", "IZUDFLT"), RegistrationKind.DYNAMIC);

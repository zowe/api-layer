...
detailed message to your email within 48 hours indicating the next steps in
...
- [CVE-2016-2216](https://nodejs.org/en/blog/vulnerability/february-2016-security-releases/):
  ...
  message splitting_. While the impact of this vulnerability is application and

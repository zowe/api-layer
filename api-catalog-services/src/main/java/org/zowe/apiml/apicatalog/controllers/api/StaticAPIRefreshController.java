...
import org.zowe.apiml.apicatalog.staticapi.StaticRegistrationService;
...
public class StaticAPIRefreshController {
    ...
    private final StaticRegistrationService staticRegistrationService;

    @PostMapping(value = "/refresh", produces = MediaType.APPLICATION_JSON_VALUE)
    public Mono<ResponseEntity<String>> refreshStaticApis() {
        return Mono.fromCallable(staticRegistrationService::refresh)

...
@Slf4j
public class ACSimpleX509AuthenticationFilter extends NonCompulsoryAuthenticationProcessingFilter {

    private final AuthenticationProvider authenticationProvider;
    private final AuthenticationSuccessHandler successHandler;

    public ACSimpleX509AuthenticationFilter(String endpoint,

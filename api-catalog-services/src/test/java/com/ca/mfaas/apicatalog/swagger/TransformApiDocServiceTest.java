...
public class TransformApiDocServiceTest {
    ...
    public void testFailedTransformationOfAPIDocWhenInvalidSwagger() {
        ...
        ResponseEntity<String> response = new ResponseEntity<>(swagger, HttpStatus.OK);
        ApiDocInfo apiDocInfo = new ApiDocInfo(null, response, null, "https", "localhost:10010");
    ...
    public void shouldGetRouteWhenApiInfoIsNull() {
        ...
        ApiDocInfo apiDocInfo = new ApiDocInfo(null, response, routedServices, "https", "localhost:10010");

...
_BPX_JOBNAME=${ZWE_zowe_job_prefix}${GATEWAY_CODE} java \
    ...
    -Dapiml.httpclient.ssl.enabled-protocols=${ZWE_configs_apiml_httpclient_ssl_enabled_protocols:-ZWE_configs_zowe_network_client_tls_maxTls:-ZWE_network_client_tls_maxTls:-"TLSv1.2"} \

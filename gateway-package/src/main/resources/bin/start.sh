...
_BPX_JOBNAME=${ZWE_zowe_job_prefix}${GATEWAY_CODE} java \
    ...
    -Dapiml.service.discoveryServiceUrlsList=${ZWE_DISCOVERY_SERVICES_LIST:-"https://${APIML_SERVICE_HOSTNAME:-discovery-service-1}:${ZWE_components_discovery_port:-7553}/eureka/"} \

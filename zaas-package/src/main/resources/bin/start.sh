...
# - ZWE_zOSMF_applId / ZWE_zosmf_applId - The z/OSMF application ID (lowercase variant is retained as a fallback)
...
_BPX_JOBNAME=${ZWE_zowe_job_prefix}${ZAAS_CODE} ${JAVA_BIN_DIR}java \
    ...
    -Dapiml.security.personalAccessToken.maxScopes=${ZWE_configs_apiml_security_personalAccessToken_maxScopes:-${ZWE_components_gateway_apiml_security_personalAccessToken_maxScopes:-64}} \
    -Dapiml.security.personalAccessToken.cutoverEpoch=${ZWE_configs_apiml_security_personalAccessToken_cutoverEpoch:-${ZWE_components_gateway_apiml_security_personalAccessToken_cutoverEpoch:-0}} \
    -Dapiml.security.personalAccessToken.cutoverSkewAllowanceSeconds=${ZWE_configs_apiml_security_personalAccessToken_cutoverSkewAllowanceSeconds:-${ZWE_components_gateway_apiml_security_personalAccessToken_cutoverSkewAllowanceSeconds:-300}} \
    -Dapiml.security.personalAccessToken.revocationLookupTimeoutMillis=${ZWE_configs_apiml_security_personalAccessToken_revocationLookupTimeoutMillis:-${ZWE_components_gateway_apiml_security_personalAccessToken_revocationLookupTimeoutMillis:-2000}} \
    -Dapiml.security.personalAccessToken.revocationLookupFailureThreshold=${ZWE_configs_apiml_security_personalAccessToken_revocationLookupFailureThreshold:-${ZWE_components_gateway_apiml_security_personalAccessToken_revocationLookupFailureThreshold:-5}} \
    -Dapiml.security.personalAccessToken.revocationLookupCircuitOpenMillis=${ZWE_configs_apiml_security_personalAccessToken_revocationLookupCircuitOpenMillis:-${ZWE_components_gateway_apiml_security_personalAccessToken_revocationLookupCircuitOpenMillis:-10000}} \
    -Dapiml.security.personalAccessToken.revocationLookupBatchKeys=${ZWE_configs_apiml_security_personalAccessToken_revocationLookupBatchKeys:-${ZWE_components_gateway_apiml_security_personalAccessToken_revocationLookupBatchKeys:-66}} \
    -Dapiml.security.personalAccessToken.revokeRuleSkewAllowanceMillis=${ZWE_configs_apiml_security_personalAccessToken_revokeRuleSkewAllowanceMillis:-${ZWE_components_gateway_apiml_security_personalAccessToken_revokeRuleSkewAllowanceMillis:-60000}} \

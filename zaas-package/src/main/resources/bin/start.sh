...
_BPX_JOBNAME=${ZWE_zowe_job_prefix}${ZAAS_CODE} ${JAVA_BIN_DIR}java \
    ...
    -Dapiml.service.http.userId=${ZWE_configs_apiml_service_http_userId:-${eurekaUserId}} \
    -Dapiml.service.http.password=${ZWE_configs_apiml_service_http_password:-${eurekaPassword}} \

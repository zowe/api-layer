...
_BPX_JOBNAME=${ZWE_zowe_job_prefix}${ZAAS_CODE} java \
    ...
    -Dapiml.connection.timeout=${APIML_CONNECTION_TIMEOUT:-10000} \
    -Dapiml.connection.timeToLive=${APIML_CONNECTION_TIMETOLIVE:-10000} \
    -Dapiml.connection.idleConnectionTimeoutSeconds=${APIML_CONNECTION_IDLECONNECTIONTIMEOUTSECONDS:-5} \

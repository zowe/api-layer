...
* **Java** 
    * Oracle or IBM Java 8 [JDK](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html)
    * Java 10+ is not supported.
* **Node.js** 
    * You should be able to run Node.js on your machine.

    ...
    public ResponseEntity<ApiMessageView> checkError(HttpServletRequest request, Throwable exc) {
        ...
        if (cause instanceof AuthenticationException) {
            ...
            if (cause instanceof TokenExpireException) {
                messageView = messageService.createMessage("org.zowe.apiml.zaas.security.expiredToken").mapToView();
            } else if (cause instanceof TokenNotValidException) {
                messageView = messageService.createMessage("org.zowe.apiml.zaas.security.invalidToken").mapToView();

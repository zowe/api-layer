...
import org.zowe.apiml.zaas.ribbon.http.RequestAbortException;
import org.zowe.apiml.zaas.ribbon.http.RequestContextNotPreparedException;
    ...
    private static Stream<Arguments> provideExceptionsWithRelevantTexts() {
        return Stream.of(
            Arguments.of("givenExceptionChain_whenIsAbortException_thenRequestAbortedGeneric",
                ...
                "The request to the URL 'null' aborted without retrying on another instance. Caused by: org.zowe.apiml.zaas.ribbon.http.RequestAbortException: test",
                "org.zowe.apiml.zaas.requestAborted"),
            Arguments.of("givenExceptionChain_whenIsAbortExceptionWithCause_thenRequestAbortedGenericAndCause",
                ...
                "The request to the URL 'null' aborted without retrying on another instance. Caused by: org.zowe.apiml.zaas.ribbon.http.RequestAbortException: org.springframework.security.access.AuthorizationServiceException: test, Caused by: org.springframework.security.access.AuthorizationServiceException: test",
                "org.zowe.apiml.zaas.requestAborted"),
            ...
            Arguments.of("givenExceptionChain_whenIsContextNotPreparedExceptionWithCause_thenContextNotPreparedAndCause",
                ...
                "org.zowe.apiml.zaas.contextNotPrepared"),
            Arguments.of("givenExceptionChain_whenIsConnectionException_thenConnectionExceptionAndCause",
                ...
                "org.zowe.apiml.zaas.connectionRefused")
        );
    }

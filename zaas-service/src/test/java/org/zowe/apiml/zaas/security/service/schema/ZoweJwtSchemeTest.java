...
import static org.zowe.apiml.zaas.security.service.schema.JwtCommand.COOKIE_HEADER;
    ...
    class GivenX509AuthSourceTest {
        ...
        class WhenCertificateInRequest {
            ...
            void whenJwtCannotBeCreatedFromX509_thenThrows() {
                ...
                when(authSourceService.getJWT(certSource)).thenThrow(new AuthSchemeException("org.zowe.apiml.zaas.security.schema.x509.mappingFailed"));

...
class CachingAuthenticationTest implements TestWithStartedInstances {
    ...
    class calledWithoutTokenOrCertificate {
        ...
        @Test
        void healthInfoApidocAreAccessible() {  // TODO: Either three tests or just one endpoint.
            given()
    ...
    class calledWithHeaderAndCertificate {
        ...
        @Test
        void cachingApiEndpointsAccessible() { // TODO: More than one reason for this test to fail.

...
/**
 * Have a selection of endpoints that we want to verify that are properly protected.
 * The protection means that they are not available without authentication
 * The authentication itself will be accepted via Bearer, Basic Headers and apiml Cookie
 */

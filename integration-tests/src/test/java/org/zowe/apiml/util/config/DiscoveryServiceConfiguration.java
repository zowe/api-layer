...
//            this.additionalPort = Integer.parseInt(additionalPort.trim());
//        }
//    }

    public Integer getAdditionalPort() {
        if (StringUtils.isBlank(additionalPort)) { return null; }
        return Integer.parseInt(additionalPort);
    }

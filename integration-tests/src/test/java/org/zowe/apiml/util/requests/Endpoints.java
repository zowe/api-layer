...
public class Endpoints {
    ...
    public final static String STATIC_CLIENT_2_REQUEST = "/staticclient2/api/v1/request";
    public final static String STATIC_CLIENT_1_REQUEST = "/staticclient/api/v1/request";

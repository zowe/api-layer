...
public class Endpoints {
    ...
    public static final String ZAAS_TICKET_ENDPOINT = "/gateway/zaas/ticket";
    public static final String ZAAS_ZOSMF_ENDPOINT = "/gateway/zaas/zosmf";
    public static final String ZAAS_ZOWE_ENDPOINT = "/gateway/zaas/zoweJwt";
    public static final String ZAAS_SAFIDT_ENDPOINT = "/gateway/zaas/safIdt";

    public static final String ROUTED_LOGIN_OLD_FORMAT = "/gateway/api/v1/auth/login";
    public static final String ROUTED_LOGOUT_OLD_FORMAT = "/gateway/api/v1/auth/logout";
    ...
    public static final String EVICT_ACCESS_TOKEN = "/gateway/auth/access-token/evict";

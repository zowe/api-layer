    ...
    class GivenTwoServices {
        ...
        class WhenOneIsDown {
            ...
            void setUp() throws LifecycleException, IOException, JSONException {
                ...
                service1 = new VirtualService("testhamodeservice1", ports.get(0)).hostname("localhost");
                service2 = new VirtualService("testhamodeservice1", ports.get(1)).hostname("localhost");
        ...
        class OneReturns503 {
            ...
            void setUp() throws LifecycleException, IOException, JSONException {
                ...
                service1 = new VirtualService("testhamodeservice2", ports.get(0)).hostname("localhost");
                service2 = new VirtualService("testhamodeservice2", ports.get(1)).hostname("localhost");

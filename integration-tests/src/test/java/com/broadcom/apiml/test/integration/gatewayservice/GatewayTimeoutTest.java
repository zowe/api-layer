...
import com.broadcom.apiml.test.integration.utils.categories.SlowTests;
import com.broadcom.apiml.test.integration.utils.http.HttpClientUtils;
...
import static com.broadcom.apiml.test.integration.utils.http.HttpRequestUtils.getUriFromGateway;

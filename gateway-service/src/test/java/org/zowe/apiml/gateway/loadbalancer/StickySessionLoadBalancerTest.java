...
class StickySessionLoadBalancerTest {
    ...
    private StickySessionLoadBalancer loadBalancer;
    ...
    void setUp() {
        ...
        this.loadBalancer = new StickySessionLoadBalancer(delegate, factory, lbCache, clock, DEFAULT_EXPIRATION_HS);
    }

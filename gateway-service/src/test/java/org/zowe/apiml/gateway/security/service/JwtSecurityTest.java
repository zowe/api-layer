...
class JwtSecurityTest {
    ...
    class WhenInitializedWithValidJWT {
        @BeforeEach
        void setUp() {
            underTest = new JwtSecurity(providers, keyAlias, "../keystore/service/service.keystore.p12", "password".toCharArray(), "password".toCharArray(), discoveryClient);
        }
    ...
    class WhenInitializedWithoutValidJWT {
        @BeforeEach
        void setUp() {
            underTest = new JwtSecurity(providers, null, "../keystore/service/service.keystore.p12", "password".toCharArray(), "password".toCharArray(), discoveryClient);
        }

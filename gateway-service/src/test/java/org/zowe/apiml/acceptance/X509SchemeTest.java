 ...
 * by the {@link org.zowe.apiml.security.common.filter.ApimlX509Filter ApimlX509Filter}.
 */
@AcceptanceTest
class X509SchemeTest extends AcceptanceTestWithTwoServices {
    ...
    @Test
    void givenValidClientCert_thenClientCertDetailsInRequestHeaders() throws IOException {
    ...
    // Test if internal APIML certificate will be passed through to a service. This should not be the case in the future.
    @Test
    void givenInternalApimlCert_thenApimlCertDetailsInRequestHeaders() throws IOException {

...
public class ResponseHeaderFixTest {
    ...
    @CsvSource({
        "0,addHeader(String name, String value)",
        "1,setHeader(String name, String value)",
        "2,setIntHeader(String name, int value)",
    ...
    void givenRequest_whenSetContentLength_thenIsPropagated(int method, String description) {
        ...
        .when()
            .get(String.format("https://localhost:%d/test/%d/%s", port, method, CONTENT_LENGHT))
        .then()
            .statusCode(SC_OK)
            .header(CONTENT_LENGHT, String.valueOf(TEST_CONTENT_LENGTH))

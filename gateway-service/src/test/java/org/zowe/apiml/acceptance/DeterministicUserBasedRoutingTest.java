...
class DeterministicUserBasedRoutingTest extends AcceptanceTestWithTwoServices {
    ...
    public void prepareApplications() {
        ...
        applicationRegistry.addApplication(serviceWithDefaultConfiguration, false, true, false, "authentication", false);
        applicationRegistry.addApplication(serviceWithCustomConfiguration, true, false, true, "authentication", false);
    }

...
public class LoginFilterTest {
    ...
    public void setUp() {
        ...
        securityObjectMapper = mock(ObjectMapper.class);
        authenticationManager = mock(AuthenticationManager.class);
        loginFilter = new LoginFilter(authEndpoint, successHandler, failureHandler, authenticationManager, securityObjectMapper);
    ...
    public void attemptAuthenticationWithWringLoginObjectFormat() throws IOException {
        ...
        when(securityObjectMapper.readValue(any(InputStream.class), isA(Class.class))).thenThrow(new IOException());
    ...
    public void attemptAuthenticationWithCorrectLoginObject() throws IOException {
        ...
        when(request.getInputStream()).thenReturn(inputStream);
        when(request.getMethod()).thenReturn(HttpMethod.POST.name());
        when(securityObjectMapper.readValue(any(InputStream.class), isA(Class.class))).thenReturn(loginRequest);
        ...
        assertThat(result, Is.is(tokenAuthentication));
    }

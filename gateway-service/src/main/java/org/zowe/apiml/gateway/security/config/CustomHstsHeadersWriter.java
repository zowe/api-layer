 ...
 * </ul>
 *
 * @see NewSecurityConfiguration
 */
public class CustomHstsHeadersWriter implements HeaderWriter {
    ...
    private final String HEADER_VALUE = DEFAULT_MAX_AGE + DEFAULT_INCLUDE_SUBDOMAINS;

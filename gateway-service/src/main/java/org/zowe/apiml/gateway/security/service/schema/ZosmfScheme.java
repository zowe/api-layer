    ...
    public class ZosmfCommand extends AuthenticationCommand {
        ...
        public void apply(InstanceInfo instanceInfo) {
            ...
            authSourceOptional.ifPresent(authSource -> {
                ...
                AuthSource.Parsed queryResponse = authSourceService.parse(authSource);
                switch (queryResponse.getSource()) {
                    case ZOSMF:
                        ...
                        setCookie(context, ZosmfService.TokenType.JWT.getCookieName(), (String)authSource.getSource());
                        break;
                    case ZOWE:
            ...
            authSourceOptional.ifPresent(authSource -> {
                ...
                switch (queryResponse.getSource()) {
                    case ZOSMF:
                        ...
                        createCookie(cookies, ZosmfService.TokenType.JWT.getCookieName(), (String)authSource.getSource());
                        break;
                    case ZOWE:
                        final String ltpaToken = authSourceService.getLtpaToken(authSource);
